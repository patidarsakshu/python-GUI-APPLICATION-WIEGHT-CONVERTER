...
okbtn = Button(root, text = "OK", command = ok, padx = 9, pady = 2,bd="5",font=" impack 10 bold"
          ,fg="#033E3E")
okbtn.grid(row = 4, column = 0, columnspan = 2, pady = 50)
Exitbtn=Button(root,text="EXIT",bd="10",fg="#033E3E",font="impack,10,bold"
          ,command=exit)
Exitbtn.grid(row=6, column=0,columnspan=3,pady=2)
